...
import { useCreateBoardMutation } from "../../services/api/boardApi";
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (res.status && res.data) {
        ...
        dispatch(
          addBoard({
            id: res.data.id || (res.data as any).board_id, // Handle both id and board_id
      ...
      console.error("❌ Error creating board:", err.data.errors.board_name);
